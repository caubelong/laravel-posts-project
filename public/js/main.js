...
//     $('.add-categories-link').click(function (){
//         $('.form-modal-category-create').toggleClass('active')
//     })
//     $('.form-category-close-form__icon').click(()=>{
//         $('.form-modal-category-create').removeClass('active')
//     })
//     //show form edit categories
//     $('.action-categories-update').click(function (e){
//         e.preventDefault()
//         $('.form-modal-category-edit').toggleClass('active')
//         //do du lieu vao form
//         let categoryName = this.dataset.categoryname
//         let parentId = this.dataset.parentid
//         let cateId = this.dataset.cateid
//         $('#categoryId').val(cateId)
//         $('#CategoryNameEdit').val(categoryName)
//         $('#selectCategoryEdit').val(parentId)
//     })
//     $('.form-category-close-form__icon').click(()=>{
